    ...
    public function run(): void
    {
        ...
        foreach ($posts as $post) {
            ...
            $metaData = [
                ...
                'keywords' => 'Ustawi Wa Jamii, community development, ' . Str::slug($post['title'], ', '),
            ];
