...
<template>
    <section id="impact" class="relative py-24 bg-gradient-to-br from-blue-600 via-sky-500 to-blue-400 overflow-hidden">
        <!-- Decorative elements -->
        ...
        <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                ...
                <div class="group" :class="{ 'opacity-0 translate-y-10': !isVisible, 'opacity-100 translate-y-0 transition-all duration-1000': isVisible }">
                    <div class="bg-white/20 backdrop-blur-sm rounded-2xl p-8 h-full transition-all duration-300 hover:bg-white/30 hover:scale-105 hover:shadow-2xl">
                        ...
                        <div class="text-4xl lg:text-5xl font-bold text-white mb-3">{{ counters.beneficiaries.toLocaleString() }}+</div>
                        <div class="text-white text-lg font-semibold mb-1">Beneficiaries Served</div>
                        <div class="text-white/80 text-sm">Across all our programs</div>
                    </div>
                </div>
            ...
            <!-- Impact Highlights -->
            <div class="mb-16">
                <h3 class="text-3xl font-bold text-center text-gray-900 mb-12">Impact Highlights</h3>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <!-- Youth Leadership -->
                    <div class="bg-white rounded-xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <div class="h-48 bg-gradient-to-br from-sky-400 to-sky-600 rounded-lg flex items-center justify-center mb-6">
                            <svg class="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                        </div>
                        <h4 class="text-xl font-bold text-gray-900 mb-3">Youth Leadership</h4>
                        <p class="text-gray-600 mb-4">Empowering young leaders through capacity building and leadership training programs.</p>
                        <div class="text-sky-500 font-semibold">500+ Youth Trained</div>
                    </div>
            ...
            <div class="text-center">
                <div class="bg-gradient-to-r from-sky-500 to-sky-600 rounded-2xl p-12 text-white">
