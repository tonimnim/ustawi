                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                >
                                    <div class="aspect-w-16 aspect-h-9 w-full overflow-hidden rounded-lg bg-gray-100">
                                        <img 
                                            :src="image.preview || `/storage/${image.path || 'homepage/' + image.filename}`" 
                            ...
                            <div class="bg-gray-900 rounded-lg overflow-hidden">
                                <div class="relative aspect-w-16 aspect-h-9">
                                    <img 
                                        ...
                                        :src="homepageImages[currentPreviewIndex].preview || `/storage/${homepageImages[currentPreviewIndex].path || 'homepage/' + homepageImages[currentPreviewIndex].filename}`" 
